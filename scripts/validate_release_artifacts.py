...
def inspect_wheel(path: Path) -> list[str]:
    ...
    required_suffixes = {
        ...
        "securedact_mcp/setup_assets/claude/.claude-plugin/marketplace.json",
        "securedact_mcp/setup_assets/claude/integrations/claude-code-enforced/securedact-enforced/.claude-plugin/plugin.json",
        "securedact_mcp/setup_assets/claude/integrations/claude-code-enforced/securedact-enforced/hooks/hooks.json",
        "securedact_mcp/setup_assets/gemini/gemini-extension.json",
        "securedact_mcp/setup_assets/gemini/hooks/hooks.json",
